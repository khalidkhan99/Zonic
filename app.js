(function () {
  ...
  function loadHeroVideo() {
    ...
    setTimeout(function () { markReady(); }, 6000);
    ...
    // Play then immediately pause — required on iOS Safari to "unlock"
    // the video element so that currentTime scrubbing works without user gesture.
    try {
      video.load();
      ...
      if (playPromise && typeof playPromise.then === 'function') {
        playPromise.then(function () {
          ...
          // Autoplay blocked — video stays paused; scrubbing still works on most browsers
        });
      }
    } catch (e) { markReady(); }
  }
